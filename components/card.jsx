    ...
    return (
      <>
        {words.map((word) => (
          <a
            href="#"
            className="m-8 block max-w-sm p-6 bg-gray-800 border border-gray-700 rounded-lg shadow hover:bg-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
          >
